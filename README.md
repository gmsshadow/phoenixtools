...
1. Install Ruby (Windows)
    ...
    a) Download [RubyInstaller for x64 bit]([http://dl.bintray.com/oneclick/rubyinstaller/rubyinstaller-2.2.3-x64.exe](https://rubyinstaller.org/downloads/)) or [RubyInstaller for x32 bit](http://dl.bintray.com/oneclick/rubyinstaller/rubyinstaller-2.2.3.exe) and install.
