class ApplicationController < ActionController::Base
  before_action :check_configuration, unless: :skip_configuration_checks
  before_action :check_setup, unless: :skip_setup_checks
  before_action :update_notice
  ...
  def update_notice
    if Nexus.config
      ...
      Nexus.config.update!(:update_notice => nil, :update_error => nil)
    end
  end
