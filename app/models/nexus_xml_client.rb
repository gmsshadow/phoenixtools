class NexusXMLClient
	...
	def fetch_positions!
		...
		Nexus.config.update!(:setup_notice => "Fetching owned positions", :update_notice => "Fetching owned positions")
		doc = doc('pos_list')
		puts doc
